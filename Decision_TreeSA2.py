...
dictChances = { 'baseline':     [0,     0,          ['BP', 'NoBP'],                     [D.BP_P, (1-D.BP_P)]],
                ...
                'No_UA':         [0,     0,          ['No_UA_PE', 'T_No_UA_HTN'],        [D.PE_MD_P, (1-D.PE_MD_P)]],
                'No_UA_PE':      [0,     0,          ['T_No_UA_E', 'T_No_UA_PE'],        [D.E_P, (1-D.E_P)]],

                #BP, MD, UA, NO MGSO4 Branch
                'UA':            [12,    0,          ['UA_PE', 'T_UA_HTN'],              [D.PE_MD_P, (1-D.PE_MD_P)]],
...
###TRAINING SCENARIO
                ...
                'Tr_No_UA':         [0,     0,             ['Tr_No_UA_PE', 'Tr_T_No_UA_HTN'],        [D.PE_MD_P, (1-(D.PE_MD_P))]],
                'Tr_No_UA_PE':      [0,     0,             ['Tr_T_No_UA_E', 'Tr_T_No_UA_PE'],        [D.E_P, (1-D.E_P)]],

                #BP, MD, UA, NO MGSO4 Branch
                'Tr_UA':            [12,     0,            ['Tr_UA_PE', 'Tr_T_UA_HTN'],              [D.PE_MD_P, (1-(D.PE_MD_P))]],
...
######SUPPLIES SCENARIO
                ...
                'sup_No_UA':         [0,     0,          ['sup_No_UA_PE', 'sup_T_No_UA_HTN'],        [D.PE_MD_P, (1-D.PE_MD_P)]],
                'sup_No_UA_PE':      [0,     0,          ['sup_T_No_UA_E', 'sup_T_No_UA_PE'],        [D.E_P, (1-D.E_P)]],

                #BP, MD, UA, NO MGSO4 Branch
                'sup_UA':            [12,    0,          ['sup_UA_PE', 'sup_T_UA_HTN'],              [D.PE_MD_P, (1-D.PE_MD_P)]],
...
######BOTH SCENARIO
                ...
                'both_No_UA':         [0,     0,          ['both_No_UA_PE', 'both_T_No_UA_HTN'],        [D.PE_MD_P, (1-D.PE_MD_P)]],
                'both_No_UA_PE':      [0,     0,          ['both_T_No_UA_E', 'both_T_No_UA_PE'],        [D.E_P, (1-D.E_P)]],

                #BP, MD, UA, NO MGSO4 Branch
                'both_UA':            [12,    0,          ['both_UA_PE', 'both_T_UA_HTN'],              [D.PE_MD_P, (1-D.PE_MD_P)]],
...
#               //key:          cost,   utility
dictTerminals = {'T_NoBP_No_HTN':       [D.PREG_COST,                   1.0],
                 'T_NoBP_HTN':          [(D.PREG_COST+D.HTN_COST),      .78],
                 'T_NoBP_PE':           [(D.PREG_COST+D.PRE_EC_COST),   .4],
                 'T_NoBP_E':            [(D.PREG_COST+D.EC_COST),       .1],

                 #NoMD
                 'T_BP_No_HTN':          [D.PREG_COST,                  1.0],
                 'T_No_MD_HTN':          [(D.PREG_COST+D.HTN_COST),     .78],
                 'T_No_MD_PE':           [(D.PREG_COST+D.PRE_EC_COST),  .4],
                 'T_No_MD_E':            [(D.PREG_COST+D.EC_COST),  .1],

                 #No UA
                'T_No_UA_HTN':          [(D.PREG_COST + D.HTN_COST),    .78],
                'T_No_UA_PE':           [(D.PREG_COST + D.PRE_EC_COST), .4],
                'T_No_UA_E':            [(D.PREG_COST + D.EC_COST),     .1],

                 #UA, No PE
                'T_UA_HTN':             [(D.PREG_COST + D.HTN_COST),    .78],

                #
                'T_No_MGSO4_PE':        [(D.PREG_COST + D.PRE_EC_COST), .4],
                'T_No_MGSO4_E':         [(D.PREG_COST + D.EC_COST),     .1],

                #MGSO4
                'T_MGSO4_PE':           [(D.PREG_COST + D.PRE_EC_COST), .4],
                'T_MGSO4_E':            [(D.PREG_COST + D.EC_COST),     .1],
#####TRAINING SCENARIO
                 'Tr_T_NoBP_No_HTN':       [D.PREG_COST,                   1.0],
                 'Tr_T_NoBP_HTN':          [(D.PREG_COST + D.HTN_COST),    .78],
                 'Tr_T_NoBP_PE':           [(D.PREG_COST + D.PRE_EC_COST), .4],
                 'Tr_T_NoBP_E':            [(D.PREG_COST + D.EC_COST),     .1],

                 #NoMD
                 'Tr_T_BP_No_HTN':          [D.PREG_COST,    1.0],
                 'Tr_T_No_MD_HTN':          [(D.PREG_COST + D.HTN_COST),    .78],
                 'Tr_T_No_MD_PE':           [(D.PREG_COST + D.PRE_EC_COST),    .4],
                 'Tr_T_No_MD_E':            [(D.PREG_COST + D.EC_COST),    .1],

                 #No UA
                'Tr_T_No_UA_HTN':          [(D.PREG_COST + D.HTN_COST),    .78],
                'Tr_T_No_UA_PE':           [(D.PREG_COST + D.PRE_EC_COST), .4],
                'Tr_T_No_UA_E':            [(D.PREG_COST + D.EC_COST), .1],

#UA, No PE
                'Tr_T_UA_HTN':             [(D.PREG_COST + D.HTN_COST),.78],


                'Tr_T_No_MGSO4_PE':        [(D.PREG_COST + D.PRE_EC_COST), .4],
                'Tr_T_No_MGSO4_E':         [(D.PREG_COST + D.EC_COST), .1],

                #MGSO4
                'Tr_T_MGSO4_PE':           [(D.PREG_COST + D.PRE_EC_COST), .4],
                'Tr_T_MGSO4_E':            [(D.PREG_COST + D.EC_COST), .1],

########SUPPLIES SCENARIO
                 'sup_T_NoBP_No_HTN':       [D.PREG_COST,     1.0],
                 'sup_T_NoBP_HTN':          [(D.PREG_COST + D.HTN_COST),     .78],
                 'sup_T_NoBP_PE':           [(D.PREG_COST + D.PRE_EC_COST),     .4],
                 'sup_T_NoBP_E':            [(D.PREG_COST + D.EC_COST),     .1],

                 #NoMD
                 'sup_T_BP_No_HTN':          [(D.PREG_COST),    1.0],
                 'sup_T_No_MD_HTN':          [(D.PREG_COST + D.HTN_COST),    .78],
                 'sup_T_No_MD_PE':           [(D.PREG_COST + D.PRE_EC_COST),    .4],
                 'sup_T_No_MD_E':            [(D.PREG_COST + D.EC_COST),    .1],

                 #No UA
                'sup_T_No_UA_HTN':          [(D.PREG_COST + D.HTN_COST),    .78],
                'sup_T_No_UA_PE':           [(D.PREG_COST + D.PRE_EC_COST), .4],
                'sup_T_No_UA_E':            [(D.PREG_COST + D.EC_COST), .1],

                #UA, No PE
                'sup_T_UA_HTN':             [(D.PREG_COST + D.HTN_COST),.78],


                'sup_T_No_MGSO4_PE':        [(D.PREG_COST + D.PRE_EC_COST), .4],
                'sup_T_No_MGSO4_E':         [(D.PREG_COST + D.EC_COST), .1],

                #MGSO4
                'sup_T_MGSO4_PE':           [(D.PREG_COST + D.PRE_EC_COST), .4],
                'sup_T_MGSO4_E':            [(D.PREG_COST + D.EC_COST), .1],


########BOTH SCENARIO
                 'both_T_NoBP_No_HTN':       [D.PREG_COST,     1.0],
                 'both_T_NoBP_HTN':          [(D.PREG_COST + D.HTN_COST),     .78],
                 'both_T_NoBP_PE':           [(D.PREG_COST + D.PRE_EC_COST),     .4],
                 'both_T_NoBP_E':            [(D.PREG_COST + D.EC_COST),     .1],

                 #NoMD
                 'both_T_BP_No_HTN':          [D.PREG_COST,    1.0],
                 'both_T_No_MD_HTN':          [(D.PREG_COST + D.HTN_COST),    .78],
                 'both_T_No_MD_PE':           [(D.PREG_COST + D.PRE_EC_COST),    .4],
                 'both_T_No_MD_E':            [(D.PREG_COST + D.EC_COST),    .1],

                 #No UA
                'both_T_No_UA_HTN':          [(D.PREG_COST + D.HTN_COST),    .78],
                'both_T_No_UA_PE':           [(D.PREG_COST + D.PRE_EC_COST), .4],
                'both_T_No_UA_E':            [(D.PREG_COST + D.EC_COST), .1],

                #UA, No PE
                'both_T_UA_HTN':             [(D.PREG_COST + D.HTN_COST),.78],

                'both_T_No_MGSO4_PE':        [(D.PREG_COST + D.PRE_EC_COST), .4],
                'both_T_No_MGSO4_E':         [(D.PREG_COST + D.EC_COST), .1],

                #MGSO4
                'both_T_MGSO4_PE':           [(D.PREG_COST + D.PRE_EC_COST), .4],
                'both_T_MGSO4_E':            [(D.PREG_COST + D.EC_COST), .1]
